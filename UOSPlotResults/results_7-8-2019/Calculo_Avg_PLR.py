...
print("PLR Avg General: " + str(np.mean(ThroughputMean)))

#test1= statistics.mean(Throughput1)
tmean1= np.mean(ThroughputMean1)

print("PLR Avg UABS: " + str(np.mean(ThroughputMean1)))
